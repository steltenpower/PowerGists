...
===============================================
- [data-centric (manifesto)](http://datacentricmanifesto.org/): Not apps, but YOU as an organisation decide what you mean exactly, where to store it, in what format, and how and where is defined what roles/groups/people have what access (full/no/structural/anonimized/synthetic).
...
- If you have done a lot of the above, you much better allow for successful Artificial Intelligence (AI) too.
