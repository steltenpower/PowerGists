...
- Pairing, instead of some of the alternation between group discussion and lone work: More immediate-feedback hands-on working with 2. Both at 1 flex desk making good use of richness of In-Real-Life communication with gestures, objects, etc., as remote with audio connection and simultaneously working in the same application context. As this is a different social construct, it allows for more personalized communication and deep learning, passed on to sessions with other where applicable.
