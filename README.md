...
===============================================
- [data-centric (manifesto)](http://datacentricmanifesto.org/): Not apps, but YOU as an organisation decide what you mean exactly, where to store it, in what format, and how and where is defined what roles/groups/people have what access.
...
- SoLiD (SOcial LInked Data): every user of an application has fine-grained control of their data, hosted outside the application in a so-called dataPOD. Less scattered data, less repeated fields, less monopoly power.
