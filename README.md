...
SVG:
====
- static/generated/interactive VISUALS consisting of objects that are intrinsically structured/layered/relatable, making it the usual format for visualizing anything expressed in some domain-specific language.
