...
# EMBED INSTEAD !
Enrich your text with algorithms (also known as **CODE**) that can run inside the document context. They can process **LIVE DATA** and show results, often plots.<br>
Electronic Lab notebook is often used as the general term for software that can do this.
